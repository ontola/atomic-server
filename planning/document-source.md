...
- [x] Implementation: lazy dialog showing pretty TipTap JSON from existing Loro conversion.
- [x] Tests: rich body, empty/error/loading, read-only/nonmutation, menu eligibility.
- [x] Documentation and coverage map.
- [x] 26 targeted tests, production build, formatting and Vite extraction. Typecheck has only pre-existing useFile.test.tsx:36 TS2352.
