...
- [x] Make tutorial describing the future situation (I think this is where we should start, so we design from the perspective of a developer) — see [`docs/src/flutter-guide/`](../docs/src/flutter-guide/1-index.md)
