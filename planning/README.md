...
| Document | Status |
| --- | --- |
| [`data-browser-ui.md`](./data-browser-ui.md) | **Proposal, nothing shipped.** Audit of the data-browser UI: no usable token layer (56 distinct font sizes, 53 gaps, 108 paddings, 39 shadows against a theme almost nothing uses), a 3-step neutral ramp anchored at pure black/white, a JS-only theme, and eagerly-imported per-class pages. Proposes CSS-variable tokens, a codemod plus a lint gate, then surface consolidation. |
