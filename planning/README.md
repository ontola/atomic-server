...
| `notion-sync.md` | **Moved to atomic-plugins** ([`integrations/notion/planning/`](https://github.com/ontola/atomic-plugins/tree/main/integrations/notion/planning)), together with `notion-integration-proxy.md` and the `notion-proxy/` OpenAPI staging files. Nothing Notion-specific remains in this repo. |
