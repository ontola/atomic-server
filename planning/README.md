...
| [`table-scale.md`](./table-scale.md) | **Measured + open-path fix.** Collection now pages local fetches (`limit`/`offset`/`sort_by`). Write amplification (4 GB / 99 ms/row) remains. Harness: `lib/tests/table_scale.rs`, `browser/e2e/tests/table-stress.spec.ts`. |
