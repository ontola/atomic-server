...
| [`mt940.md`](./mt940.md) | **Pilot implemented.** Sandboxed MT940 and camt.053 import, exact amounts, balance checks, nested table and repeat detection; real bunq sample validated locally; exact-decimal aggregation remains. |
