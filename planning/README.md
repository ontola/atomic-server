...
| [`ts-wasm-duplication.md`](./ts-wasm-duplication.md) | **Analysis.** How much `@tomic/lib` duplicates `atomic_lib`, measured TS-vs-WASM and FFI-boundary costs; concludes the JS `Resource` cache should stay in TS rather than move into WASM. |
