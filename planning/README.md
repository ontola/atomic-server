...
| Document | Status |
| --- | --- |
| [`atomic-flutter-sdk.md`](./atomic-flutter-sdk.md) | **In progress:** extract reusable `atomic_flutter` Dart/Flutter SDK (auth, sync, pairing UI, drives) from the canvas app. |
