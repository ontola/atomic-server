...
| Document | Status |
| --- | --- |
| [`docs-refresh.md`](./docs-refresh.md) | **Active (2026-08-04):** audit + drafting checklist to bring public docs in line with local-first, DID, sync, tables, i18n, CMS, and presence. |
