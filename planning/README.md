...
| Document | Status |
| --- | --- |
| [`commit-performance.md`](./commit-performance.md) | **In progress (2026-08-03):** cut per-commit CPU/payload — fork instead of snapshot round-trip on clone/apply, drop double `resource_old` clone, `sign_at` exports incremental `loroUpdate`. |
