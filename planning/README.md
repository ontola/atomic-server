...
| [`table-scale.md`](./table-scale.md) | **Measured.** 100k-row table stress: Collection hydrates every match on open; the grid is already virtual. Harness: `lib/tests/table_scale.rs`, `browser/e2e/tests/table-stress.spec.ts`. |
