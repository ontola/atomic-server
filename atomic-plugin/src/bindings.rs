...
macro_rules! __export_world_class_extender_cabi {
    ($ty:ident with_types_in $($path_to_types:tt)*) => {
        const _ : () = { #[unsafe (export_name = "class-url")] unsafe extern "C" fn
        export_class_url() -> * mut u8 { unsafe { $($path_to_types)*::
        _export_class_url_cabi::<$ty > () } } #[unsafe (export_name =
        "cabi_post_class-url")] unsafe extern "C" fn _post_return_class_url(arg0 : * mut
        u8,) { unsafe { $($path_to_types)*:: __post_return_class_url::<$ty > (arg0) } }
        #[unsafe (export_name = "on-resource-get")] unsafe extern "C" fn
        export_on_resource_get(arg0 : * mut u8, arg1 : usize, arg2 : * mut u8, arg3 :
        usize, arg4 : * mut u8, arg5 : usize, arg6 : * mut u8, arg7 : usize, arg8 : * mut
        u8, arg9 : usize,) -> * mut u8 { unsafe { $($path_to_types)*::
        _export_on_resource_get_cabi::<$ty > (arg0, arg1, arg2, arg3, arg4, arg5, arg6,
        arg7, arg8, arg9) } } #[unsafe (export_name = "cabi_post_on-resource-get")]
...
macro_rules! __export_class_extender_impl {
    ...
    ($ty:ident with_types_in $($path_to_types_root:tt)*) => {
        $($path_to_types_root)*:: __export_world_class_extender_cabi!($ty with_types_in
        $($path_to_types_root)*);
    };
}
#[doc(inline)]
