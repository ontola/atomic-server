...
use super::common::get_resource_text_parts;
use super::embeddings::Embedder;
use super::fastembed_gpu::fastembed_gpu_execution_providers;
use super::table::{create_resources_table, open_resources_table, table_vector_dimension};
...
impl VectorSearchState {
    ...
    pub async fn new(
        ...
        let (embedder, rerank_model) = if enabled {
            let embedder = super::embeddings::create_embedder(config).await?;
            ...
            (super::embeddings::stub_embedder(STUB_DIM), None)
        };
