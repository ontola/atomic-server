...
In a [local-first](local-first.md) setup it is the always-on device: the replica that a browser tab can reach, that stays online while your phone and laptop sleep, and that serves the same data over HTTP.
