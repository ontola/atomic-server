...
pub const MEAL_NOTES: &str = "https://atomicdata.dev/properties/mealNotes";
pub const MEAL_EMBEDDING: &str = "https://atomicdata.dev/properties/mealEmbedding";
pub const EMBEDDED_BY_MODEL: &str = "https://atomicdata.dev/properties/embeddedByModel";
pub const COPIED_FROM_MEAL: &str = "https://atomicdata.dev/properties/copiedFromMeal";
